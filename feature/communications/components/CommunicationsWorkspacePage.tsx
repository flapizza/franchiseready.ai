...
export function CommunicationsWorkspacePage({ state, initialCompose = false, initialCandidateId, initialIdempotencyKey = "" }: { state: CommunicationsWorkspaceState; initialCompose?: boolean; initialCandidateId?: string; initialIdempotencyKey?: string }) {
