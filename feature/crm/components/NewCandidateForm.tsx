...
export function NewCandidateForm() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {(state.status === "validation-error" || state.status === "unavailable") && <div role="alert" className="rounded-xl border border-red-200 bg-red-50 p-4 text-sm font-semibold text-red-700">{state.message}</div>}
