...
export type Campaign={id:string;name:string;description:string;subject:string;previewText:string;senderName:string;replyTo:string;audienceType:"segment"|"list"|null;audienceId:string;content:import('../studio/persistence').StoredContent;status:CampaignStatus;updatedAt:string};
