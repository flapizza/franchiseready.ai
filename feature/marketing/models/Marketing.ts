...
export type Campaign={brandingSnapshot?:import('../media/model').BrandingSnapshot|null;id:string;name:string;description:string;subject:string;previewText:string;senderName:string;replyTo:string;audienceType:"segment"|"list"|null;audienceId:string;content:import('../studio/persistence').StoredContent;status:CampaignStatus;updatedAt:string};
export type CampaignSave=Omit<Campaign,'updatedAt'> & {expectedUpdatedAt?:string};
