import { Award, Building2, CalendarDays, CheckCircle2, ClipboardList, Compass, Mail, RefreshCw, Sparkles, UserPlus } from "lucide-react";
...
const icons: Record<CandidateActivityIcon, typeof Sparkles> = {
  ...
  referral: Award, stage: RefreshCw, activity: CheckCircle2, email: Mail, meeting: CalendarDays,
};
