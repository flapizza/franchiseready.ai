...
export function CandidateRelationshipOverview({ candidate }: { candidate: Candidate360State }) {
  return (
    <section className="grid gap-6 xl:grid-cols-[1.35fr_0.85fr]">
      ...
      {!candidate.rootOnly && !candidate.hasIntelligence && <div className="xl:col-span-2"><AssessmentInvitationAction candidateId={candidate.id} existingUrl={candidate.assessmentUrl} /></div>}
