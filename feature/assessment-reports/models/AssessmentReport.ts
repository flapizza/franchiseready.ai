...
export type AssessmentReportType = "COMPLETED_ASSESSMENT" | "CANDIDATE_ASSESSMENT_REPORT" | "CONSULTANT_INTELLIGENCE_REPORT";
...
export type AssessmentReport = {
  ...
  templateVersion: "completed-assessment-v1" | "candidate-report-v1" | "consultant-report-v1";
