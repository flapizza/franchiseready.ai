...
export default defineConfig({
  testDir: "./e2e", testMatch: ["marketing-composer-workspace.spec.ts", "marketing-studio.spec.ts", "marketing-segments-campaigns.spec.ts", "marketing-campaign-delivery.spec.ts"],
